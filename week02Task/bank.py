...
# Python input () function allows for user input,
...
# The f-string is a way of formatting strings in Python.
# It allows you to directly include variables & expressions in the string
# and to perform calculations within the curly brakets.
# See geeks for Geeks for information on f-strings:
# https://www.geeksforgeeks.org/formatted-string-literals-f-strings-python/
# The / operator divides the newAmount by 100 to convert cents to euro.
# See W3 Schools for Python operators:
# https://www.w3schools.com/python/python_operators.asp
# The : .2f formats the float amount to two decimal places.
